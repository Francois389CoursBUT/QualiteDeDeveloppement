...
public class Matiere implements Serializable {
    ...
    /**
     * Afficher en boucle un menu indiquant l'ensemble des notes pour les
     * étudiants inscrits dans cette matière avec la possibilité de les
     * modifier.
     */
                ...
                if (n <= etudiantsInscrits.length) {
                    ...
                    try {
                        ...
                        if (note >= 0 && note <= 20) {
                            ...
                            System.out.println("Note mal saisie !");
                        }
                    } catch (NumberFormatException e) {
                        System.out.println("Note mal saisie !");
                    }
                } // 3. Si choix de terminer les modifications des notes (pour cette matière)
                else if (n == etudiantsInscrits.length + 1) {
                    finModifications = true;
