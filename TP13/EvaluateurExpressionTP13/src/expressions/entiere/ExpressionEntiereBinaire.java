...
public class ExpressionEntiereBinaire implements ExpressionEntiere {
    ...
    private ExpressionEntiere gauche, droite;
    ...
    public ExpressionEntiereBinaire construireExpression(TexteExpression te) 
        ...
        try {
            ...
            // tenter de construire les opérandes gauche et droite puis l'expression binaire à renvoyer.
                ...
                ExpressionEntiere gauche = FactoryExpressions.getInstance()
                        .construireExpressionEntiere(te); 
                te.caractereSuivant(); 
                ExpressionEntiere droite = FactoryExpressions.getInstance()
                        .construireExpressionEntiere(te);
